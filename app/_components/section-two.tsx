			...
			<div className="space-y-8">
				...
				<ul className="space-y-4">
					<li className="flex items-center gap gap-4">
						...
						Eliminating rugs & centralized risks – No hidden mint
						functions, no liquidity pulls.
					</li>
					...
					<li className="flex items-center gap gap-4">
						...
						Ensuring fair launches & decentralized ownership – No VC
						dumps, no early insider advantages.
					</li>
					...
					<li className="flex items-center gap gap-4">
						...
						Incentivizing long-term holding – Staking rewards,
						deflationary mechanics, and buyback burns.
					</li>
				</ul>
